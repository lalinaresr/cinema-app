			...
			<?php if (
				...
				<form action="<?= site_url('results/pre_search_query/'); ?>" method="post" class="navbar-form navbar-left" role="search">
					<div class="input-group">
						<input type="text" class="form-control" name="movie_name_search" id="movie_name_search" placeholder="Search Movie" required autocomplete="off" style="width: 100%;">
				...
				<ul class="nav navbar-nav navbar-right">
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-globe"></span> Productors <span class="caret"></span></a>
					...
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-globe"></span> Genders <span class="caret"></span></a>
						<ul class="dropdown-menu">
					...
					<li class="dropdown">
						<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"><span class="glyphicon glyphicon-tags"></span> Categorys <span class="caret"></span></a>
						<ul class="dropdown-menu">
					...
					<li><a href="<?= site_url('dashboard/'); ?>" target="_blank"><span class="glyphicon glyphicon-dashboard"></span> Dashboard</a></li>
					<li class="dropdown">
