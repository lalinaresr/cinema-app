<li class="dropdown">
    ...
    <ul class="dropdown-menu">
        <?php foreach ($productors->result_array() as $productor) : ?>
            <li><a href="<?= site_url("welcome/filter_by_productor/{$productor['productor_slug']}"); ?>"><?= $productor['productor_name']; ?></a></li>
        <?php endforeach; ?>
    </ul>
</li>
<li class="dropdown">
    ...
    <ul class="dropdown-menu">
        <?php foreach ($genders->result_array() as $gender) : ?>
            <li><a href="<?= site_url("welcome/filter_by_gender/{$gender['gender_slug']}"); ?>"><?= $gender['gender_name']; ?></a></li>
        <?php endforeach; ?>
    </ul>
</li>
<li class="dropdown">
    ...
    <ul class="dropdown-menu">
        <?php foreach ($categories->result_array() as $category) : ?>
            <li><a href="<?= site_url("welcome/filter_by_category/{$category['category_slug']}"); ?>"><?= $category['category_name'] ?></a></li>
        <?php endforeach; ?>
    </ul>
</li>