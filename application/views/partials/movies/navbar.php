      ...
      <div class="collapse navbar-collapse navbar-ex1-collapse">
         <ul class="nav navbar-nav visible-xs">
            ...
            <?php if ($this->session->userdata('is_admin_logged_in')){ ?>
               ...
               <li class="active"><a href="<?= site_url('movies/'); ?>"><span class="glyphicon glyphicon-cd"></span> Movies</a></li>
         ...
         <ul class="nav navbar-nav navbar-right">
            ...
            <li class="dropdown">
               <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <?php if (strcmp($this->session->userdata('user_avatar'), 'NO-IMAGE') == 0): ?>
                     <img src="<?= encryp_image_base64(base_url() . 'assets/images/users/default.png'); ?>" class="profile-image img-circle" style="width: 20px; height: 20px;"> <?= $this->session->userdata('user_username'); ?> <b class="caret"></b>
                  <?php else: ?>
                     <img src="<?= encryp_image_base64(base_url() . $this->session->userdata('user_avatar')); ?>" class="profile-image img-circle" style="width: 20px; height: 20px;"> <?= $this->session->userdata('user_username'); ?> <b class="caret"></b>
                  <?php endif ?> 
               </a>
