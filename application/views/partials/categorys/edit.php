      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
         <h1 class="page-header">Categorys Management | Edit.</h1>
         <div class="row">
            <form action="<?= site_url('categorys/update/'); ?>" method="post" id="form-update-category">
               ...
               <!-- buttons ACTIONS -->               
               <div class="col-md-4">
                  <button type="submit" class="btn btn-info" id="btn-update-category"><span class="glyphicon glyphicon-refresh"></span> Update Category</button>                  
