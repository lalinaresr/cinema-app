<div class="row mb-20">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<h2 class="text-info tx"><span class="glyphicon glyphicon-asterisk"></span> Search Movies by: <?= $param_search; ?></h2>
	</div>
	...
	<?php else : ?>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="alert alert-warning">
				...
				<strong>Advertence Message!</strong> No found data movies about of this param search, try again
			</div>
		</div>
	<?php endif ?>
</div>