<?php if (!is_null($movie)) : ?>
    ...
    <div class="row my-3">
        <div class="col-md-9">
            <div class="fb-comments" data-href="<?= site_url("watch/{$movie['movie_slug']}"); ?>" data-numposts="100" data-colorscheme="dark" data-width="100%"></div>
            <div id="fb-root"></div>
            <script>
                (function(d, s, id) {
...
<?php else : ?>
    <div class="row">
        <?php $this->load->view('components/common/not-found', ['message' => 'La película que intenta reproducir no existe por ahora']); ?>
    </div>
<?php endif; ?>