<div class="row mb-3">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<h2 class="text-info"><span class="glyphicon glyphicon-th-list"></span> Resultados de su búsqueda "<i><?= $search_parameter; ?></i>"</h2>
	</div>
		...
		<?php foreach ($results->result_array() as $key => $value) : $id_movie_encryp = cryp($value['id_movie']); ?>
			<div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 my-thumbnail">
				<div class="thumbnail bg-black">
					<img src="<?= base_url($value['movie_cover']); ?>" class="img-responsive img-rounded">
					<div class="caption">
	...
	<?php else : ?>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="alert alert-danger">
				<strong>¡Aviso!</strong> No se encontraron películas con estos parámetros de búsqueda en estos momentos.
			</div>
		</div>
	<?php endif ?>
</div>