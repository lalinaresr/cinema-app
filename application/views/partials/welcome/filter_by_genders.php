<div class="row mb-3">
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
		<h2 class="text-info"><span class="glyphicon glyphicon-film"></span> Películas de "<i><?= $gender['gender_name']; ?></i>"</h2>
	</div>
	...
	<?php else : ?>
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<div class="alert alert-danger">
				<strong>¡Aviso!</strong> No se encontraron películas de este género en estos momentos.
			</div>
		</div>
	<?php endif ?>
</div>