      ...
      <div class="collapse navbar-collapse navbar-ex1-collapse">
         <ul class="nav navbar-nav visible-xs">
            ...
            <?php if ($this->session->userdata('is_admin_logged_in')){ ?>
               <li class="active"><a href="<?= site_url('users/'); ?>"><span class="glyphicon glyphicon-user"></span> Users</a></li>
               <li><a href="<?= site_url('sessions/'); ?>"><span class="glyphicon glyphicon-list-alt"></span> Sessions</a></li>
               <li><a href="<?= site_url('qualitys/'); ?>"><span class="glyphicon glyphicon-flag"></span> Qualities</a></li>
