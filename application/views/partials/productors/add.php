<h1 class="page-header">Productors Management | Add.</h1>
<div class="row">
   <form action="<?= site_url('productors/insert/'); ?>" method="post" id="form-insert-productor" enctype="multipart/form-data">
         ...
         <div class="modal-dialog">
            <div class="modal-content">
               <div class="modal-header bg-black">
                  ...
                  <h4 class="modal-title tx-white text-center">Preview Image Logo</h4>
               </div>
      ...
      <!-- buttons ACTIONS -->
      <div class="col-md-4">
         <button type="submit" class="btn btn-info" id="btn-insert-productor"><span class="glyphicon glyphicon-floppy-disk"></span> Save Productor</button>
